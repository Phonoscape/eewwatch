...
namespace VoiceBase
{
    class VoiceBase
    {
        protected Dictionary<string, string> gobiList { get; set; }

        protected Dictionary<string, double> intnationList { get; set; }

        protected double[] talkSpeedList { get; } = { 1.25, 0.90 };
        protected string styleName { get; } = "緊急用";

        protected string gobi { get; set; }

        protected string speaker { get; set; }
        protected int speakerID { get; set; } = 3;
        protected int presetID { get; set; } = 0;
        protected double intonation { get; set; } = 1.0;

        protected string URL { get; set; } = "http://127.0.0.1:50021/";
        //private string URL = "http://127.0.0.1:50020/";
        protected HttpClient web { get; set; }
        protected Dictionary<string, int> speakerList { get; set; }
        ...
        public virtual void Init(string sp,int vvTalkSpeed)
        {
        ...
        protected bool ServiceCheckAsync()
        {
            var _isReady = false;
